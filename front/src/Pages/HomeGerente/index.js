...
export function HomeGerente({statusLogin}){
    ...
    return (
        <Geral>
            <MenuSuperior>
                ...
                <NomeUsuario> Bem Vindo Gerente </NomeUsuario>
            ...
            <ConteudoLateral>
                ...
                <Item onClick={() => handleClickItem("5")}>
                    <ImagemItem5></ImagemItem5>
                    <TextoItem> Pesquisar Funcionário </TextoItem>
                </Item>
                <Item onClick={() => handleClickItem("6")}>
                    <ImagemItem6></ImagemItem6>
                    <TextoItem> Pesquisar Gerente </TextoItem>
                </Item>
            </ConteudoLateral>
            <ConteudoPrincipal>
